...
public static class Program
{
  ...
  {
    Console.WriteLine("Registry.Tool — Tool registry management");
    Console.WriteLine();
    Console.WriteLine("Usage: registry <command> [args]");
    Console.WriteLine();
    Console.WriteLine("Commands:");
    Console.WriteLine("  registry bootstrap-tools-v0    Bootstrap tools registry");
    Console.WriteLine("  registry verify-tools-v0       Verify tools registry");
    Console.WriteLine();
